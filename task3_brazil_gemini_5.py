...
while True:
    ...
    if dictt["Steps"] == "seat2":
        ...
        response = model.generate_content([img2, "this is the first guest", img,
                                           "here have 5 seats(white sofa or a small white chair) please tell me where is he sitting, just give me number in [1,2,3,4,5], there should be 1 numbers, answer format: ******[...]******"])
        file_data_string = response.text
        print(file_data_string)
        time.sleep(1)
        file_data_string = file_data_string.replace("**", "")
        response = model.generate_content([img,
                                           "here have 5 seats(white sofa or a small white chair) please tell me where have empty seats(white sofa or a small white chair), just give me number in [1,2,3,4,5], there should be 3 numbers, answer format: ******[numbers]******, for example ******[1,2,3]******"])
