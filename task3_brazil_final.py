        ...
        while not rospy.is_shutdown():
            ...
            if step == "name":
                ...
                if say_cnt == 0:
                    ...
                    speak11("Please answer my following question in complete sentence with louder voice, for example my interest is playing football")
                    time.sleep(1)
                ...
                if s=="":
                    repeat_cnt+=1
                if (name_cnt == "none" and s != "") or repeat_cnt>=100:
            ...
            if step == "interest":
                ...
                if s=="":
                    repeat_cnt+=1
                if (interest_name == "none" and s != "") or repeat_cnt>=100:
                    speak("please speak louder")
                    repeat_cnt=0
