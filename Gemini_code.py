...
while True:
    ...
    if dictt["Steps"]=="first":
        ...
        Manipulation2: Go to the $ROOM1, grasp the $OBJECT on the $PLACE1 and give it to $PERSON.
        ...
        *** {"1":[],"2":[],"3":[]} ***
        ...
        promt2 = dictt["Voice"]
        promt = promt2
        image_url = f"http://192.168.50.147:8888{'/uploads/GDPR.jpg'}"
        print("Fetching image from:", image_url)
        image_response = requests.get(image_url)
        ...
        if "food" in promt2 or "kitchen" in promt2 or "item" in promt2:
            promt1 ='''
                    ...
                    Task Item :     Light Bulb, Dice, Block
